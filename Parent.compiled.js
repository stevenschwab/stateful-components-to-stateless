(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    var _homeCcuserBabelscriptsReactTransformComponentExports2 = (0, _reactTransformComponentExports2.default)({
      filename: '/home/ccuser/workspace/react-102-stateless-inherit-stateful-intro-stateful-component-init/Child.js',
    ...
    var _homeCcuserBabelscriptsReactTransformComponentExports2 = (0, _reactTransformComponentExports2.default)({
      filename: '/home/ccuser/workspace/react-102-stateless-inherit-stateful-intro-stateful-component-init/Parent.js',
      components: _components,
      locals: [module],
      imports: [_react3.default]
    });
    ...
    var Parent = _wrapComponent('Parent')(function (_React$Component) {
      ...
      _createClass(Parent, [{
        key: 'render',
        value: function render() {
          return _react3.default.createElement(_Child.Child, { name: this.state.name });
        }
      }]);
